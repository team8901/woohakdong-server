...
public record ClubItemRegisterRequest(
        ...
        @Schema(example = "ELECTRONICS", description = "물품 카테고리")
    ...
    public ClubItemRegisterCommand toCommand() {
        return new ClubItemRegisterCommand(
                name,
                photo,
                description,
                location,
